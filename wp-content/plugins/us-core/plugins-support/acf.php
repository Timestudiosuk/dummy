...
if ( ! function_exists( 'us_acf_get_elm_link_options' ) ) {
	add_filter( 'us_get_link_options', 'us_acf_get_elm_link_options', 2, 1 );
	/**
	 ...
	 */
	function us_acf_get_elm_link_options( $link_options ) {
