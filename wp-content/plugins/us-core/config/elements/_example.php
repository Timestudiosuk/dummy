	...
	'params' => array(
		...
		'option_name' => array(
			...
			'link_additional_values' => array(
				'post' => 'Post Link',
				'archive' => 'Taxonomy Archive Link',
				'elm_value' => 'Clickable value (email, phone, website)',
				'popup_post' => 'Open Post in popup',
				'popup_image' => 'Open Image in popup',
				'author_page' => 'Author Page',
				'author_website' => 'Author website (if set)',
			),
		),
