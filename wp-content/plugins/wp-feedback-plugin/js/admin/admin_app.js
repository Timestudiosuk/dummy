...
jQuery_WPF(document).ready(function(){
    ...
    // img_dwn_icon  = "<span id='' class='wpf_image_download' onclick='wpf_image_download_action(this)'>"+image_download_icon+"</span><span id='' class='wpf_image_open' onclick='wpf_image_open_new_tab(this)'>"+image_open_icon+"</span><span class='wpf_image_delete'>"+image_close_icon+"</span>";
    ...
    jQuery_WPF(document).on('click','.wpf_push_media',function(){
        ...
        let id_element=jQuery_WPF(this).parent().parent().parent().attr('id'); // taking the id from "data-comment_id"
        ...
        jQuery_WPF.ajax({
            ...
            beforeSend: function(){
                console.log(curElement.parents('.chat_author').length);
                // jQuery_WPF('.wpf_loader_'+current_id).show(); //wpf_loader_admin
...
jQuery_WPF("body").scroll(function() {
    if(document.body.scrollTop > 100){
        // jQuery_WPF(".wpf_settings_sidebar").css("top", document.body.scrollTop-100);
...
function generate_comment(id){
    ...
    jQuery_WPF.ajax({
        ...
        success: function(data){
            ...
            // var comment_html = '<li class="wpf_author"><level class="task-author">'+current_user_name+' '+wpf_just_now+'</level><div class="meassage_area_main"><p class="chat_text">'+URLify(temp_task_text)+'</p></div></li>';
            jQuery_WPF('#task_comments_'+id).append(comment_html);
            jQuery_WPF('#comment-'+id).val('');
            /*jQuery_WPF('.wpf_current_chat_box').animate({scrollTop: jQuery_WPF(".wpf_current_chat_box li").last().offset().top},2000);*/
            jQuery_WPF('#task_comments_'+id).animate({scrollTop: jQuery_WPF('#task_comments_'+id).prop("scrollHeight")}, 2000);
...
function load_wpfb_tasks_admin(){
    ...
    jQuery_WPF.ajax({
        method:"POST",
        url: ajaxurl,
        data: {action:'load_wpfb_tasks_admin',wpf_nonce:wpf_nonce,wpf_current_screen:wpf_current_screen,all_page:0,task_page_url:current_page_url},
	/*beforeSend: function(){
...
function generate_wpfb_task_html(wpfb_task_id,wpfb_metas){
    ...
    if(wpfb_metas.task_type=='general'){
        ...
        for (var key in wpfb_metas.comments) {
            ...
            // if(wpfb_metas.comments[key].is_edited==true){
            //     var edited_html='<span class="wpf-is-edited">(edited)</span>';
            // }else{
            //     var edited_html='';
            // }
            ...
            if(wpfb_metas.comments[key].comment_type==0){
                ...
                // img_dwn_icon  = "<span id='wpf_image_download' class='wpf_image_download' onclick='wpf_image_download_action(this)'>"+image_download_icon+"</span><span id='' class='wpf_image_open' onclick='wpf_image_open_new_tab(this)'>"+image_open_icon+"</span><span class='wpf_image_delete'>"+image_close_icon+"</span>";
                // wpfb_messages_html += '<li class="'+task_author+' is_image"  data-comment_id="'+key+'"><level class="task-author">'+author+'<span>'+wpfb_metas.comments[key].time+'</span></level><div class="meassage_area_main">'+img_dwn_icon+'<a href="'+wpfb_metas.comments[key].message+'" target="_blank"><img src="'+wpfb_metas.comments[key].message+'" class="wpf_task_uploaded_image" /></a></div></li>';
...
function wpf_generate_general_task_html(wpfb_task_id,wpfb_metas){
    ...
    for (var key in wpfb_metas.comments) {
        ...
        if(wpfb_metas.comments[key].comment_type==0){
            ...
            // wpfb_messages_html += '<li class="'+task_author+' is_file" data-comment_id="'+key+'"><level class="task-author">'+author+'<span>'+wpfb_metas.comments[key].time+'</span></level><div class="meassage_area_main"><img src="'+wpfb_metas.comments[key].message+'" class="wpf_task_uploaded_image" /></div></li>';
            wpfb_messages_html += '<li class="'+task_author+' is_image" data-comment_id="'+key+'"><level class="task-author">'+author+'<span>'+wpfb_metas.comments[key].time+'</span></level><div class="meassage_area_main"><a href="'+wpfb_metas.comments[key].message+'" target="_blank">'+'</a>'+img_dwn_icon+'<img src="'+wpfb_metas.comments[key].message+'" class="wpf_task_uploaded_image" /></div></li>';
        }
        else if (wpfb_metas.comments[key].comment_type==3) {
                ...
                wpfb_messages_html += '<li class="'+task_author+' is_image" data-comment_id="'+key+'"><level class="task-author">'+author+'<span>'+wpfb_metas.comments[key].time+'</span></level><div class="meassage_area_main"><iframe width="100%" height="120" src="https://www.youtube.com/embed/'+wpfb_metas.comments[key].message+'"></iframe></div></li>';
        }
        else{
            var wpf_download_file  = wpfb_metas.comments[key].message.split("/").pop();
            wpfb_messages_html += '<li class="'+task_author+'" data-comment_id="'+key+'"><level class="task-author">'+author+'<span>'+wpfb_metas.comments[key].time+'</span></level><div class="meassage_area_main"><a href="'+wpfb_metas.comments[key].message+'" download="'+wpf_download_file+'" target="_blank" ><i class="gg-software-download"></i> '+ wpf_download_file+'</a></div></li>';
        }
        jQuery_WPF('#task_comments_'+comment_count).append(wpfb_messages_html);
...
function wpf_task_popover_html(wpf_task_type, comment_count, wpfb_task_id, wpfb_metas, wpfb_users_html, wpfb_task_priority_html, wpfb_task_status_html, wpfb_messages_html,new_task_popover) {
	...
	//     var display_sticker = '<span class="'+wpfb_metas.task_priority+' '+wpfb_metas.task_priority+'_custom" ></span>';
    ...
    mark_as_complete_checkbox = "<input type='checkbox' data-id='"+comment_count+"' class='mark_as_complete_checkbox wpf_checkbox' id='mark_complete_"+comment_count+"' "+dissabled_attr+" " + task_status_complete_checked + "><label class='wpf_checkbox_label mark_as_complete_lable' for='mark_complete_"+comment_count+"'>Mark As Complete</label>";
            ...
            success: function (data) {
                ...
                if(response.status==1){
                    ...
                    if(response.type==1){
                        ...
                        // var comment_html = '<li class="wpf_author is_image"><level class="task-author">'+current_user_name+'</level><div class="meassage_area_main"><a href="'+response.message+'" target="_blank"></a><img src="'+response.message+'" />'+img_dwn_icon+'</div></li>';
                    }
                    else{
                        ...
                        // var comment_html = '<li class="wpf_author"><level class="task-author">'+current_user_name+'<span>'+wpf_just_now+'</span></level><div class="meassage_area_main"><a href="'+response.message+'" download="'+wpf_download_file+'" target="_blank"><i class="gg-software-download"></i> '+ wpf_download_file+'</a></div></li>';
                    }
...
//     if ( jQuery_WPF('#wpf_frontend_container_today li').length == 0 ) {
//         jQuery_WPF('#wpf_frontend_container_today').append('<li class="no_task_found">No Task Found!</li>');
//     }

//     if ( jQuery_WPF('#wpf_frontend_container_yesterday li').length == 0 ) {
//         jQuery_WPF('#wpf_frontend_container_yesterday').append('<li class="no_task_found">No Task Found!</li>');
//     }

//     if ( jQuery_WPF('#wpf_frontend_container_this_week li').length == 0 ) {
//         jQuery_WPF('#wpf_frontend_container_this_week').append('<li class="no_task_found">No Task Found!</li>');
//     }

//     if ( jQuery_WPF('#wpf_frontend_container_this_month li').length == 0 ) {
//         jQuery_WPF('#wpf_frontend_container_this_month').append('<li class="no_task_found">No Task Found!</li>');
//     }

//     if ( jQuery_WPF('#wpf_frontend_container_year li').length == 0 ) {
//         jQuery_WPF('#wpf_frontend_container_this_year').append('<li class="no_task_found">No Task Found!</li>');
//     }

//     if ( jQuery_WPF('#wpf_frontend_container_other li').length == 0 ) {
//         jQuery_WPF('#wpf_frontend_container_other').append('<li class="no_task_found">No Task Found!</li>');
//     }
