...
//        $current_page_title = addslashes(get_the_title($current_page_id));
	...
	if ($wpf_active == 1 && $wpf_check_page_builder_active == 0 && $wpf_allow_backend_commenting != 'yes' && $wpf_current_screen != 'settings_page_menu_editor' && (!$is_site_archived)) {
	    ...
	    /* If compact mode enabled, load it and don't load the bottom bar => v2.1.0 */
            ...
            if ( $enable_compact_mode !== 'yes' ) {
                $bottom_bar_html = '<div id="pushed_to_media" class="wpf_hide"><div class="wpf_notice_title">' . __("Pushed to Media Folder.", "wpfeedback") . '</div><div class="wpf_notice_text">' . __("The file was added to the website's media folder, you can now use it from the there.", "wpfeedback") . '</div></div><div id="wpf_already_comment" class="wpf_hide"><div class="wpf_notice_title">' . __("Task already exist for this element.", "wpfeedback") . '</div><div class="wpf_notice_text">' . __("Write your message in the existing thread. <br>Here, we opened it for you.", "wpfeedback") . '</div></div><div id="wpf_reconnecting_task" class="wpf_hide" style="display: none;"><div class="wpf_notice_title">' . __("Remapping task....", "wpfeedback") . '</div><div class="wpf_notice_text">' . __("Give it a few seconds. <br>Then, refresh the page to see the task in the new position.", "wpfeedback") . '</div></div><div id="wpf_reconnecting_enabled" class="wpf_hide" style="display: none;"><div class="wpf_notice_title">' . __("Remap task", "wpfeedback") . '</div><div class="wpf_notice_text">' . __("Place the task anywhere on the page to pinpoint the location of the request.", "wpfeedback") . '</div></div><div id="wpf_launcher" data-html2canvas-ignore="true"><div class="wpf_launch_buttons" style="'.$bottom_button_style.'"><div class="wpf_start_comment"><a href="javascript:enable_comment();" title="' . __('Click to give your feedback!', 'wpfeedback') . '" data-placement="left" class="comment_btn" id="wpf_enable_comment_btn"><i class="gg-math-plus"></i></a></div>
                <div class="wpf_expand"><a href="javascript:expand_bottom_bar()" id="wpf_expand_btn" title="Panel"><img title="Panel" src="'. get_wpf_favicon().'" style="width:65px" /></a></div></div>
                <div class="wpf_sidebar_container" style="opacity: 0; margin-right: -380px";>
                <div class="wpf_sidebar_header">
                <!-- =================Top Tabs================-->
                    <div class="top_tabs">
                        <button class="wpf_tab_sidebar wpf_thispage wpf_active" onclick="openWPFTab_admin(\'wpf_thispage\')" >' . __('This Page', 'wpfeedback') . '</button>
                ...
                <div class="filter_ui_content">
                            <div id="wpf_side_filter">
                                ...
                                <div class="wpf_list wpf_hide" id="wpf_search_filter_btn"><div id="sidebar_search" class="wpf_search_box"><span class="wpf_search_box">
                                    ...
                                    <input onkeyup="wp_feedback_cat_filter(event, this)" type="text" name="wpf_search_title" class="wpf_search_title" value="" id="wpf_search_title" placeholder="'.__("Search by task title", "wpfeedback").'"></span></div>
                                </div>
                            </div>                        
                </div> 
...
if (!function_exists('wpfeedback_add_stylesheet_to_admin')) {
	...
	wp_enqueue_style('wpf_wpf-common');
        ...
        wp_localize_script( 'wpf_admin_script', 'logged_user', array( 'current_user' => $wpf_user_type ) );
        ...
        //echo $wpf_allow_backend_commenting;die;
...
//        }
        ...
        if(isset($_POST['wpf_current_screen']) && $_POST['wpf_current_screen'] !='' && $_POST['all_page'] !=1){
                ...
                $post_data = array(
                    ...
                    'wpf_site_id' => get_option('wpf_site_id'),
                    'wpf_current_screen' => $_POST['wpf_current_screen'],
...
//                        'task_page_title' => '',
                        ...
                        'url'   => home_url(),
                        'is_admin_task' => 1,
                        'from_frontend' => isset($_POST['from_frontend']) ? $_POST['from_frontend'] : 0
                );
