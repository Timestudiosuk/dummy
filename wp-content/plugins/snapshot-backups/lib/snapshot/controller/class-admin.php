...
class Admin extends Controller {
	...
	public function add_shared_dependencies() {
		...
		: sprintf( __( 'You are currently using Email & Password as your preferred login method. Please try to re-authenticate using your email and password. Or, if you wish to change the login method, you can change it from <a href="%s" target="_blank">your accounts</a> page.', 'snapshot' ), esc_url( $account_link ) );
		...
		: sprintf( __( 'You are currently using Google Account as your preferred login method. Please try to re-authenticate using your Google Account. Or, if you wish to change the login method, you can change it from <a href="%s" target="_blank">your accounts</a> page.', 'snapshot' ), esc_url( $account_link ) );
